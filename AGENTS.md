...
- Single app at the repo root. **Not a monorepo.** No workspaces, no Turborepo.
  (v1's AGENTS.md claimed Turborepo; there was never a `turbo.json`.)
...
`npm run dev` serves on :3000. **The preview config does not run it** — `.Codex/launch.json`
...
From the design source (Codex Design project `665e9737-ca19-4932-8725-f907669cb6fb`).
